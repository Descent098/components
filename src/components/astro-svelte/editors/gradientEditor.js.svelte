...
<fieldset>
    ...
    <label class="input">
        ...
        <input type="color" name="color1" id="defaultImageColor1" bind:value={color1}>
    </label>
    <label class="input">
        <span class="label">Start Percentage</span>
        <input class="range" type="range" name="colorPercentage1" id="defaultImageColorPercentage1" bind:value={colorPercentage1} min="0" max="100">
    </label>
</fieldset>
<fieldset>
    ...
    <label class="input">
        <span class="label">Color</span>
        <input type="color" name="color2" id="defaultImageColor2" bind:value={color2}>
    </label>
    <label class="input">
        <span class="label">End Percentage</span>
        <input class="range" type="range" name="colorPercentage2" id="defaultImageColorPercentage2" bind:value={colorPercentage2} min="0" max="100" >
    </label>
</fieldset>
{#if gradientType !== "radial-gradient"}
<fieldset>
    ...
    <input class="range" type="range" name="angle" id="defaultImageAngle" bind:value={angle} max="360" min="0" >
...
<fieldset>
    ...
    <select name="gradientType" id="defaultImageGradientType" class="select" bind:value={gradientType}>
        <option value="linear-gradient">Linear Gradient</option>
        <option value="radial-gradient">Radial Gradient</option>
    </select>
</fieldset>
<div>Preview</div>
<div id="gradientPreview" style={`background: ${gradientString}`}></div>
