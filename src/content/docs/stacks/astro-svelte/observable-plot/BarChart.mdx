...
<BarChart data={[{age:22, weight:175}, {age:18, weight:150}]} xAxisDataField="age" yAxisDataField="weight" xAxisLabel="Age (years)" yAxisLabel="Weight (lbs)" colorConfig={{scheme:"Oranges", domain:[0,200]}} fillDataField="weight" client:load/>
